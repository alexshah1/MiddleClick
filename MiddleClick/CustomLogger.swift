...
final class CustomLogger: Sendable {
  ...
  /// ## To view logs
  /// ```sh
  /// log stream --predicate 'subsystem == "com.alexander.MiddleClickPlus"' --style compact --level info
  /// ```
  ...
  /// ## To view logs
  /// ```sh
  /// log stream --predicate 'subsystem == "com.alexander.MiddleClickPlus"' --style compact
  /// ```
